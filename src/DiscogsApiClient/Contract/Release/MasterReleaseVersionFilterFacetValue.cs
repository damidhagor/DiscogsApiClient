...
/// <summary>
/// Filter facets for a master release version request
/// </summary>
/// <param name="Title">Facet title</param>
/// <param name="Value">Facet value (value formatted to use in the actual query string)</param>
/// <param name="Count">Number results being filtered by this facet</param>
public sealed record MasterReleaseVersionFilterFacetValue(
