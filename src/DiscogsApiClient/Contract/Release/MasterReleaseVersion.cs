...
/// <param name="Label">Publishing label</param>
/// <param name="Country">Published in country</param>
...
/// <param name="Statistics">Community and user statistics for this release</param>
