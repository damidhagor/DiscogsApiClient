...
/// <param name="Id">Facet id (name of an available filter)</param>
/// <param name="Values">Possible facet values to filter by</param>
public sealed record MasterReleaseVersionFilterFacet(
