...
/// <summary>
/// Community information regarding a release
/// </summary>
/// <param name="UsersOwningReleaseCount">How many users own this release</param>
/// <param name="UsersWantingReleaseCount">How many users want this release</param>
...
public sealed record ReleaseCommunity(
    ...
    int UsersOwningReleaseCount,
    [property:JsonPropertyName("want")]
    int UsersWantingReleaseCount,
