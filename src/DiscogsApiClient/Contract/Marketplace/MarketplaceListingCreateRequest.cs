...
/// <summary>
/// The request body for creating a new Marketplace listing.
/// </summary>
...
/// <param name="Status">
/// The status of the listing. Use <see cref="MarketplaceListingStatus.Draft"/> to create the listing without
/// publishing it for sale, or <see cref="MarketplaceListingStatus.ForSale"/> to publish it immediately.
/// </param>
...
/// </param>
public sealed record MarketplaceListingCreateRequest(
