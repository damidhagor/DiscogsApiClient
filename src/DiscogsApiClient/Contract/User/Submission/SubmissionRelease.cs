...
/// <summary>
/// A release submitted by a user, as returned in a user's submissions.
/// </summary>
...
public sealed record SubmissionRelease(
    ...
    IReadOnlyList<SubmissionReleaseArtist> Artists,
    [property:JsonPropertyName("artists_sort")]
    string ArtistsSort,
    [property:JsonPropertyName("labels")]
    IReadOnlyList<SubmissionReleaseLabel> Labels,
    [property:JsonPropertyName("series")]
    IReadOnlyList<SubmissionReleaseLabel>? Series,
    [property:JsonPropertyName("companies")]
    IReadOnlyList<SubmissionReleaseLabel>? Companies,
