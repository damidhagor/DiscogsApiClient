...
/// </summary>
public interface IDiscogsOAuthAuthenticationProvider
{
    /// <summary>
    ...
    /// <para />
    /// The returned access token and secret are not persisted by the library — cache them however suits your
    /// application (e.g. secure storage, a database) and feed them back in on a later run via
    /// <see cref="Authenticate(string, string)"/> to skip the interactive flow.
    /// </summary>
