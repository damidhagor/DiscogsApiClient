...
internal static class DiscogsApiUrls
{
    ...
    public static readonly string CollectionFolderUrl = $"{BaseUrl}/users/{{0}}/collection/folders/{{1}}";
    ...
    public static readonly string CollectionValueUrl = $"{BaseUrl}/users/{{0}}/collection/value";
    ...
    public static readonly string ReleaseStatsUrl = $"{BaseUrl}/releases/{{0}}/stats";
